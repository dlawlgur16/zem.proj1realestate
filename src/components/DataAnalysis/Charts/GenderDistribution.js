...
const GenderDistribution = ({ data, total, selectedAgeGroup, setSelectedAgeGroup }) => {
  return (
    <div className="chart-card">
      <h3 className="chart-card__title">성별 분포</h3>
...
export default React.memo(GenderDistribution);
